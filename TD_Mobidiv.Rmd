...
![Dispositif expérimental](C:/Users/gmontaze/Documents/Work/Postdoc/Enseignements/SupAgro_12_2021/TD/DATA/Fig1.png)
...
```{r}
data <- read.csv("pheno.csv", header=T, sep=",")
str(data)
...
geno <- read.csv("geno.csv", header = T, sep=",")
dim(geno)
geno[1:5,1:5]
...
map <- read.table("pos.csv", header = T, sep=",", row.names = 1)
